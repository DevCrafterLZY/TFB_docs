...
def is_actor() -> bool:
    """
    Determine whether it is currently running in the actor.
    """
...
class RayActorPool:
    ...
    Unlike ray's built-in ActorPool, this implementation attempts to support time limiting for each task.
    """
